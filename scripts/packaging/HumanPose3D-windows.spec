...
#   ./scripts/packaging/build.sh windows
#
# Direct usage (requires flags):
#   uv run pyinstaller scripts/packaging/HumanPose3D-windows.spec -y --distpath bin --workpath bin/build
