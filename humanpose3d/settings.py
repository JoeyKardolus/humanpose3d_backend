...
# Email settings for bug report notifications
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "noreply@kinetiq.local")
BUG_REPORT_RECIPIENT = os.environ.get("BUG_REPORT_EMAIL", "joey.kardolus@student.hu.nl")
